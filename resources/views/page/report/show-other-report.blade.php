                ...
                <tbody>
                    @foreach ($reports as $key => $data)
                        <tr>
                            ...
                            <td>{{ $data->laporan->jenis_laporan }}</td>
                            <td>{{ $data->laporan->tanggal_ubah }}</td>
                            <td class="flex items-center justify-center gap-4">
                                {{-- @if ($data->laporan->status != 'publish' && $data->laporan->status != 'verification') --}}
                                    <a href="{{ route('report.other-document-completion', $data->id_laporan) }}" class="hover:shadow-lg hover:scale-110">
                                ...
                                {{-- @endif --}}
                                <a href="{{ route('download.report', $data->laporan->file_laporan) }}" class="hover:shadow-lg hover:scale-110">
