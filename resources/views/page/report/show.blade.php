    ...
    <div class="lg:w-10/12 w-11/12 bg-white rounded-2xl lg:mt-[100px] lg:ml-[100px] mt-[55px] ml-[10px] mr-6 mb-6">
        ...
        <div class="p-8">
            ...
            <div class="flex items-center justify-center mt-10">
                <button type="menu" data-target="#lampiran-tab" class="tab active w-full px-4 py-2 bg-custom-green-600 text-white font-bold shadow-sm hover:bg-[#1d4b13] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3F6137]">Lampiran</button>
