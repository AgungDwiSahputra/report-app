...
@section('content')
    <div class="lg:w-10/12 w-11/12 bg-white rounded-2xl lg:mt-[100px] mt-[60px] lg:ml-[100px] mx-auto mr-6 mb-6">
        ...
        <a href="{{ route('pengajuan.create') }}" type="button" class="flex items-center justify-center gap-3 mr-auto w-full h-12 text-sm text-center px-4 py-2 mt-20 mb-10 cursor-pointer bg-custom-green-700 text-white font-bold shadow-sm hover:bg-[#1d4b13] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3F6137]">
