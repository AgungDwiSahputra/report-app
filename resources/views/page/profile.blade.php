        ...
        <div>
            <form action="" method="POST" id="profile-form" class="md:grid lg:grid-cols-3 md:grid-cols-2 md:gap-4">
                ...
                <div class="flex items-center justify-center gap-5 lg:col-span-3 md:col-span-2 mt-9">
                    ...
                    <!-- Button Ganti Kata Sandi -->
                    <a href="{{ route('page.change-password') }}" type="button" class="block mr-auto w-[180px] h-[50px] text-sm lg:leading-7 leading-9 text-center px-4 py-2 cursor-pointer bg-custom-green-700 text-white font-bold rounded-md shadow-sm hover:bg-[#1d4b13] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3F6137]">
                        Ganti Kata Sandi
                    </a>
                </div>
            </form>
