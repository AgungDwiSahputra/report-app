...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
            <div class="flex items-center justify-center flex-col h-screen bg-custom-green">
                ...
                <div class="lg:w-[439px] sm:w-[90%] h-[auto] bg-white rounded-2xl py-14 px-8">
                    <form>
                        <!-- Input Text -->
                        <div class="mb-2">
                            {{-- <label for="text-input" class="block text-gray-700">Text Input</label> --}}
                            <input placeholder="Username" type="text" name="username" id="text-input" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-custom-green focus:border-custom-green hover:border-custom-green active:border-custom-green sm:text-md">
                        </div>
                        ...
                        <div class="mb-14 flex items-center justify-between">
                            <div>
                                <!-- Ingat Saya ? -->
                                <input type="checkbox" name="remember_me" id="remember_me" class="bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-custom-green focus:border-custom-green hover:border-custom-green">
